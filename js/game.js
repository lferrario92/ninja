...
function preload () {
  ...
  this.load.spritesheet('player_handgun', 'assets/test_off.png', { frameWidth: 66, frameHeight: 60 }
  ); // Made by tokkatrain: https://tokkatrain.itch.io/top-down-basic-set
  this.load.image('bullet', 'assets/test_on.png');
  this.load.image('target', 'assets/cap.png');
...
function create () {
  ...
  this.input.keyboard.on('keydown_T', function (pointer, time, lastFired) {
...
function update (time, delta) {
  ...
  if (joystick.left()) {
    player.body.velocity.x = (joystick._stickX - joystick._baseX) * theConstant;
    player.angle = calcAngleDegrees(joystick._stickX - joystick._baseX, joystick._stickY - joystick._baseY);
  }
  ...
  if (joystick.up()) {
    player.body.velocity.y = (joystick._stickY - joystick._baseY) * theConstant;
    player.angle = calcAngleDegrees(joystick._stickX - joystick._baseX, joystick._stickY - joystick._baseY);
  }
